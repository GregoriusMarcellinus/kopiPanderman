...
if ((isset($_POST['MM_insert'])) && ($_POST['MM_insert'] == "oiaya")) {
    ...
    $insertSQL = sprintf(
        "INSERT INTO `tb_produk` (`id_toko`, `nama_produk`, `berat`, `dimensi`, `deskripsi`, `stok`, `harga`, `gambar`) VALUES (%d, %s, %d, %s, %s, %d, %d, %s)",
        app($koneksi, $_POST['id_toko'], "int"),
        app($koneksi, $_POST['nama_produk'], "text"),
        app($koneksi, $_POST['berat'], "int"),
        app($koneksi, $_POST['dimensi'], "int"),
...
if ((isset($_POST['MM_view'])) && ($_POST['MM_view'] == "oiaya")) {
    ...
    $LoginRS__query = sprintf(
        "SELECT id_produk, nama_produk, berat, dimensi, deskripsi, stok, terjual, harga, gambar FROM tb_produk WHERE id_toko=%s ORDER BY id_produk DESC",
...
//VIEW PRODUK BERDASARKAN ID_PRODUK (GET)
