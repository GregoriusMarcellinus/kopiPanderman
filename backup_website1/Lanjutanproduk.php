...
if (isset($_GET['delete'])) {
   ...
   header('location:Lanjutanproduk.php');
};
      ...
      <table class="product-display-table">
         ...
         <?php while ($row = mysqli_fetch_assoc($select)) { ?>
            <tr>
               ...
               <td>
                  <a href="Update.php?edit=<?php echo $row['id_produk']; ?>" class="btn"> <i class="fas fa-edit"></i> edit </a>
                  <a href="Lanjutanproduk.php?delete=<?php echo $row['id_produk']; ?>" class="btn"> <i class="fas fa-trash"></i> delete </a>
               </td>
            </tr>
            <?php $nomor++; ?>
         <?php } ?>
